...
### การบันทึกผลการทดลอง
   จากการทดลอง พบว่า Relay โดยจากโค้ตโปรแกรมจะสั่งให้เปิด-ปิดสวิซ์ทุก ๆ 0.5 วินาที รีเลย์จะมีเสียงการสลับขาไป-มา ช่วงเปิด-ปิด และรีเลย์จะมีแสง สลับกับไม่มีแสง 



### อภิปรายผลการทดลอง
   จากการรันโปรแกรมเข้าไมโครคอนโทรเลอร์ทำให้เปิด-ปิดทุก ๆ 5 วินาที เมื่อพบว่าสามารถรันโปรแกรมเข้าไมโครคอนโทรเลอร์ได้แล้วจึงเปลี่ยนมาต่อกับ Relay
โดยใช้ไฟเลี้ยงจาก power bank พบว่า Relay จะมีเสียงขาสลับไปมา ทุก ๆ 5 วินาที
