...
4. เปิด Command Prompt แล้วเข้าไปในโฟล์เดอร์ที่จะอัพโหลด เช่น ไดฟ์ D ไฟล์ ชื่อ Wifi-Wed-Server
  ...
  จะแสดงโปรแกรมทั้งหมด 9 ตัว
    ...
    * 08_MQTT-publish
    * 09_MQTT-subscript
* โดยการทดลองที่ 5 เป็นการใช้ไวไฟจากไมโครคอนโทรเลอร์สร้างเว็บเซอร์เวอร์ จึงเรียกใช้ โปรแกรมที่โดยพิม **cd 05_Wifi-Wed-Server** แล้วกด **Enter**
...
![image](https://user-images.githubusercontent.com/80879565/112434611-5d8b4e00-8d76-11eb-9a2a-dc69bbffff32.png)



### การบันทึกผลการทดลอง
   จากการทดลอง พบว่า เมื่อสร้างเว็บเซอร์เวอร์สำเร็จ จะแสดง Hello cnt โดยจะเพิ่มทีละ1 คือ Hello 1 Hello 2 ...


### อภิปรายผลการทดลอง
   จากการการใช้ไมโครคอนโทรเลอร์เชื่อมต่อไวไฟ แล้วนำมาสร้างเว็บ ในการ setup เมื่อสร้างเว็บสำเร็จ จะแสดง Hello 1 Hello 2 ... แต่เนื่องจากคลิปดูได้ 2 นาทีกว่า ๆ
 จึงไม่สามารถอธิบายผลลัพท์ที่ได้มาได้
  
  
### คำถามหลังการทดลอง
* ทำไมคลิปถึงมีปัญหา
   - น่าจะเกิดการลงแล้วยังอัปโหลดไม่สมบูรณ์ทำให้คลิปมีปัญหา
